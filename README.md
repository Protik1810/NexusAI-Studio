...
[![Hardware](https://img.shields.io/badge/Hardware-NVIDIA%20CUDA%20%7C%20AMD%2FIntel%20Vulkan-success?style=for-the-badge&logo=nvidia)](https://github.com)
[![Engine](https://img.shields.io/badge/Diffusion%20Engine-stable--diffusion.cpp-orange?style=for-the-badge)](https://github.com)
[![LLM](https://img.shields.io/badge/Dialogue%20Engine-llama.cpp%20GGUF-purple?style=for-the-badge)](https://github.com)
...
- **Themes**:
  ...
  2. âš¡ **Neon Cyber** (Rainy Cyberpunk Streets)
  3. ðŸŽ¬ **Cinema Gold** (Vintage 35mm Hollywood Film Set)
  4. ðŸ•¶ï¸ **Synthwave Sunset** (Retro 80s Wireframe Grid)
  5. ðŸŒ¸ **Anime Fantasy** (Ethereal Sakura Shrine Twilight)
  6. ðŸŸ¢ **Emerald Matrix** (Bioluminescent Cyber Mainframe)
...
| Layer | Technology |
|---|---|
| **Desktop Wrapper** | Electron v44 (Chromium runtime, dark chrome, custom tray & splash) |
...
```bash
# Build standalone Windows package (.exe)
